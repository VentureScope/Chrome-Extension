...
function initializeEventListeners() {
  ...
  // Data View
  document
    .getElementById("backFromData")
    .addEventListener("click", () => showScreen("dashboard"));

  // Settings
  document
    .getElementById("backFromSettings")
    .addEventListener("click", () => showScreen("dashboard"));
  document
    .getElementById("clearDataBtn")
    .addEventListener("click", handleClearData);
  document
    .getElementById("autoSyncToggle")
  ...
  // Consent Modal
  document
    .getElementById("acceptConsentBtn")
    .addEventListener("click", handleAcceptConsent);
  document
    .getElementById("declineConsentBtn")
    .addEventListener("click", handleDeclineConsent);
  document
    .getElementById("closeConsentBtn")
    .addEventListener("click", closeConsentModal);
}
...
async function handleSync() {
  ...
  try {
    ...
    if (!portalCheck.isASTU) {
      closeConsentModal();
      alert(
        "Please navigate to ASTU e-Student portal (https://estudent.astu.edu.et/)",
      );
    ...
    closeConsentModal();
    let errorMessage =
      "Unable to sync. Please try reloading the page and try again.";

    if (error.message.includes("Receiving end does not exist")) {
      errorMessage =
        "Connection failed. Please reload the current page and try again.";
    } else if (error.message.includes("Cannot access")) {
      errorMessage =
        "Cannot access this page. Try navigating to ASTU portal first.";
    }
